...
#                     print (_test_f1,flush=False)
                    ...
                    for i in range(FLAGS.n_tasks):
                        ...
                        if FLAGS.n_tasks == 3:
                            ...
                            test_auc[i] += _test_auc[i]
                if FLAGS.n_tasks == 1:
                    print('Epoch {}, loss={:.2f}, train accuracy = {}, test accuracy '
                      '= {}, test fscore '
                      '= {}, test auc'
                      '= {}'.format(epoch+1, train_loss/num_batches,
                                        train_acc/num_batches, test_acc/num_batches_test,test_fscore/num_batches_test, test_auc/num_batches_test),file=output_file, flush=True)
                if FLAGS.n_tasks == 3:
                    print('Epoch {}, loss={:.2f}, train accuracy = {}, test accuracy '
                      '= {}, test p '
                      '= {}, test r '
